    ...
    <form method="post" action="{{ route('products.store')}}">
        ...
        <div class="row">
            ...
            <!-- importer -->
                ...
                <Button class="btn btn-info col" type="submit">Add Product</Button>
            </div>
        </form>
</div>              
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button form="{{'delete_products'.$count}}">Delete</button>
                                    <form id="{{ 'delete_products'.$count}}" action="{{route("products.destroy", ['product' => $count])}}" method="post">
                                        @csrf
                                        @method('delete')
                                    </form>
                                </td>
