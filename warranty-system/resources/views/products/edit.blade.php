        ...
        <div class="row">
            ...
            <div class="col-3 bg-color-light-scale-1 py-5">
                ...
                <select class="form-control mb-3" name="customer_id">
                    @foreach ($customers as $customer)
                        ...
                        @if($customer->id == $product['customer_id'])
                        selected
                        @endif
            ...
            <div class="col-6">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-7">
                        <input type="text" name="name" value="{{$product['name']}}" class="form-control" id="inputDefault">
                    </div>
                </div>
                <div class="form-group row">
                    @error('serial')
                    ...
                    <div class="col-lg-7">
                        <input type="text" name="serial" value="{{$product['serial']}}" class="form-control" id="inputDefault">
                    </div>
                </div>
                <div class="form-group row">
                    @error('problem')
                    ...
                    <div class="col-lg-7">
                        <input type="text" name="problem" value="{{$product['problem']}}" class="form-control" id="inputDefault">
                    </div>
                </div>
                <div class="form-group row">
                    @error('sale_date')
                    ...
                    <div class="col-lg-7">
                        <input type="text" name="sale_date" value="{{$product['sale_date']}}" class="form-control" id="inputDefault">
                    </div>
                </div>
            </div>
            <!-- importer -->
                <div class="col-3 bg-color-light-scale-1 py-5">
                    ...
                    <select class="form-control mb-3" name="importer_id">
                        @foreach ($importers as $importer)
                            ...
                            @if($importer->id == $product['importer_id'])
                             selected
                            @endif
