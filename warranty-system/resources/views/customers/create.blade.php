                ...
                <div class="col">
                    <section class="card card-admin">
                        <header class="card-header">
                            ...
                            <h2 class="card-title text-center">Create a New Customer</h2>
                        </header>
                        <div class="card-body">
                            <form action="{{route('customers.store')}}" class="form-horizontal form-bordered" method="post">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <button class="btn btn-success col-lg-6 float-left" type="submit">Create Customer</button>
                                </div>
                            </form>
                        </div>
                    </section>
