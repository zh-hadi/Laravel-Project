        ...
        <form action="{{route('my-jobs.update', ['my_job' => $job])}}" method="post">
            ...
            <div class="grid grid-cols-2 mb-4 gap-4">
                ...
                <div>
                    ...
                    <x-radio-group name="experience" :options="\App\Models\Job::$experience" :value="$job->experience" :default_option="false" />
                </div>

                <div>
                    <x-label for="catagories">Catagorie</x-label>
                    <x-radio-group name="catagories" :options="\App\Models\Job::$catagories" :value="$job->catagories" :default_option="false"/>
                </div>
